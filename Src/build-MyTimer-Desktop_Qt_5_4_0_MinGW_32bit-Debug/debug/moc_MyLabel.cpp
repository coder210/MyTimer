...
#include "../../MyTimer/mytimer-src/MyLabel.h"
...
QT_MOC_LITERAL(1, 8, 9), // "dbClicked"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "MyLabel\0dbClicked\0"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::dbClicked)) {
                *result = 0;
            }
        }
    }
